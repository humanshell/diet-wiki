...
## Why the Shift?
The legacy Friedewald formula becomes increasingly inaccurate as triglyceride levels rise, often underestimating LDL-C. Modern equations account for variations in lipoprotein composition, providing more reliable data for [dyslipidemia-management](../concepts/dyslipidemia-management.md) and [risk-stratification](../concepts/risk-stratification.md).

## Recommendation
Clinicians should transition to Martin/Hopkins or Sampson/NIH for all routine LDL-C estimation to ensure treatment decisions are based on accurate lipid quantification.

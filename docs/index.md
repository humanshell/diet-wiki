...
- **[omega-3-fatty-acids](entities/omega-3-fatty-acids.md)** — EPA and DHA from fish; ALA from canola oil and walnuts
- **[alpha-linolenic-acid](entities/alpha-linolenic-acid.md)** — Plant-based omega-3; the key cardioprotective nutrient in the Lyon study
- **[lipoprotein-a](entities/lipoprotein-a.md)** — Lp(a), an independent ASCVD risk marker elevated in many post-MI patients
- **[apolipoprotein-b](entities/apolipoprotein-b.md)** — ApoB, the primary structural protein of atherogenic lipoprotein particles
- **[sodium](entities/sodium.md)** — Key target for reduction; Mediterranean cooking replaces salt with herbs, garlic, and lemon
- **[potassium](entities/potassium.md), [magnesium](entities/magnesium.md), [calcium](entities/calcium.md)** — Electrolytes that support blood pressure regulation through vascular tone
...
|---|---|---|---|
| [Shakshuka (Poached Eggs in Tomato Pepper Sauce)](recipes/shakshuka.md) | ★★★★★ 4.98 · 215 reviews | Mediterranean/Middle Eastern | 40 min |
| [Greek Green Beans (Fasolakia Lathera)](recipes/greek-green-beans-fasolakia.md) | ★★★★★ 5.0 · 73 reviews | Greek | 60 min |
| [Mediterranean White Bean Soup](recipes/mediterranean-white-bean-soup.md) | ★★★★½ 4.93 · 103 reviews | Italian | 45 min |
| [Baba Ganoush](recipes/baba-ganoush.md) | ★★★★★ 4.96 · 42 reviews | Middle Eastern | 35 min |
| [Greek Chicken Salad](recipes/greek-chicken-salad.md) | ★★★★★ 5.0 · 20 reviews | Greek | 35 min |
| [Everyday Mediterranean Salad](recipes/everyday-mediterranean-salad.md) | ★★★★½ 4.87 · 29 reviews | Mediterranean | 10 min |
...
*To add or update pages, edit the relevant file and append a record to [log](log.md).*